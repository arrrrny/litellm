...
MAX_RETRIES=10
RETRY_COUNT=0
ENDPOINT="http://localhost:4001/health/liveliness"
...
echo ""
echo "Access the proxy at: http://localhost:4001"
echo "View logs with:      docker-compose logs -f"
echo "Stop with:           docker-compose down"
echo ""
echo "To debug GitHub Copilot integration:"
echo "python3 debug_github_copilot.py"
echo ""
echo "To run comprehensive tests:"
echo "python3 test_github_copilot_integration.py"
echo ""
echo "Manual curl tests for GitHub Copilot models:"
echo ""
echo "# GPT-4.1 Streaming:"
echo "curl -X POST http://localhost:4000/chat/completions \\"
echo "     -H \"Content-Type: application/json\" \\"
echo "     -H \"Authorization: Bearer sk-54SEwvGVBHXvgrZ4cg89cQ\" \\"
echo "     -d '{\"model\": \"github_copilot/gpt-4.1\", \"messages\": [{\"role\": \"user\", \"content\": \"Hello from GitHub Copilot!\"}], \"stream\": true, \"intent\": true}'"
echo ""
echo "# Claude 3.5 Sonnet Streaming:"
echo "curl -X POST http://localhost:4000/chat/completions \\"
echo "     -H \"Content-Type: application/json\" \\"
echo "     -H \"Authorization: Bearer sk-54SEwvGVBHXvgrZ4cg89cQ\" \\"
echo "     -d '{\"model\": \"github_copilot/claude-3.5-sonnet\", \"messages\": [{\"role\": \"user\", \"content\": \"Explain recursion briefly\"}], \"stream\": true, \"intent\": true}'"
echo ""
echo "# Gemini 2.5 Pro Streaming:"
echo "curl -X POST http://localhost:4000/chat/completions \\"
echo "     -H \"Content-Type: application/json\" \\"
echo "     -H \"Authorization: Bearer sk-54SEwvGVBHXvgrZ4cg89cQ\" \\"
echo "     -d '{\"model\": \"github_copilot/gemini-2.5-pro\", \"messages\": [{\"role\": \"user\", \"content\": \"What is clean code?\"}], \"stream\": true, \"intent\": true}'"
echo ""
echo "Running debug script automatically..."
python3 debug_github_copilot.py
